...
export default async function SeriesPage() {
    ...
    const series = await getAllContentByCategory("series");
        ...
        <div className="min-h-screen bg-transparent pt-32 pb-32">
            <div className="max-w-[1440px] mx-auto px-10 xl:px-16">
                <div className="flex flex-col gap-2 mb-12">
                    ...
                    <p className="text-white/50 text-[15px] font-medium tracking-wide">Explore our complete collection of {series.length} premium series.</p>
                </div>
